...
public class TransactionController {
    ...
    public ResponseEntity<TransactionDTO> getTransactionById(@PathVariable String id) {
        ...
        return transaction.map(t -> ResponseEntity.ok(toDTO(t))).orElseGet(() -> ResponseEntity.notFound().build());
    }
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TransactionDTO> updateTransaction(@PathVariable String id, @RequestBody TransactionRequestDTO req) {
        Transaction transaction = fromRequestDTO(req);
    ...
    private Transaction fromRequestDTO(TransactionRequestDTO req) {
        ...
        t.setType(req.getType() != null ? com.montage.engine.model.TransactionType.valueOf(req.getType()) : null);
    ...
    private TransactionDTO toDTO(Transaction t) {
        ...
        if (t.getDate() != null && t.getTime() != null) {
            timestamp = t.getDate().atTime(t.getTime()).atZone(java.time.ZoneId.systemDefault()).toInstant().toEpochMilli();
        }
