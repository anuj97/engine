...
public class SettlementService {
    ...
    public Settlement recordSettlement(String fromUserId, String toUserId, Double amount, String splitExpenseId, String note) {
        Settlement settlement = new Settlement(null, fromUserId, toUserId, amount, splitExpenseId, note);
